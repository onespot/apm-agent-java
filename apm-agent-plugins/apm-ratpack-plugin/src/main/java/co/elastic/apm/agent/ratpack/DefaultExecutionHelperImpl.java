    ...
    public void activateWhenBound(final Execution execution, final ElasticApmTracer tracer, final Class<TransactionHolder> transactionToken) {
        ...
        if (optional.isPresent()) {
            ...
            if (currentTransaction == null && transaction != null) {
                ...
                logger.warn("Not activating scope for transaction. Current transaction [{}] and stored transaction [{}] did not pass assertions.", currentTransaction, transaction);
            }
        }
    }
        ...
        if (optional.isPresent()) {
            ...
            if (transaction != null) {
                ...
                if (scope != null) {
                    ...
                    logger.warn("Not closing scope for transaction. Current transaction [{}] and stored transaction [{}] did not pass assertions.", currentTransaction, transaction);
                }
            }
        }
    }
