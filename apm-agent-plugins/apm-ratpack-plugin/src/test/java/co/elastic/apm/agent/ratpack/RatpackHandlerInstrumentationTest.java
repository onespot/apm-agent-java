...
class RatpackHandlerInstrumentationTest extends AbstractInstrumentationTest {
            ...
            RatpackServer.of(s -> {
                ...
                s.handlers(c -> {
                    ...
                    c.get("proxy", ctx -> {
                        ...
                        final String path = "https://www.elastic.com/";
    ...
    @Test
    void shouldIntegrateWithOtherInstrumentedLibraries() throws Exception {
        assert client != null;
        ...
        // then
        assertHasOneTransaction("GET /proxy", 200);
        assertFirstRequestContains(path, Objects::isNull);
    }
    ...
    private void assertFirstError(final Class<?> exceptionClass) {
